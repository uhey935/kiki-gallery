...
| Document                                                       | Purpose                                                                                                                                                    |
| -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Exhibitions / Artists Rename Reference Update Architecture** | Defines the bounded typed-reference graph, reviewed multi-file transaction, byte-exact rollback, and exact Publish set without authorizing implementation. |
...
Approves the design boundary for future Exhibitions and Artists Rename. It
...
later exact Publish path set. It preserves all asset bytes/paths and leaves
implementation, Works-specific lifecycle semantics, Delete, and Production
behavior deferred.
