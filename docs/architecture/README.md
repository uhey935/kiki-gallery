...
| **Exhibitions Localization Architecture**                      | Defines the implementation-ready three-file target, locale capabilities, facade/routes, Editor lifecycle, News/Artist/Works integration, and migration safety contract. |
