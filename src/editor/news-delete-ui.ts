export const newsDeleteEndpoint = "/editor/api/news-delete";

export const newsDeleteFailureGuidance = (code?: string) =>
  ({
    "backup-proof-required":
      "Choose a complete backup generation, then review again.",
    "backup-proof-stale":
      "Create and verify a fresh generation containing the current News file.",
    "incoming-reference":
      "Remove the incoming reference with a separately reviewed Save or keep this News.",
    "parser-uncertainty":
