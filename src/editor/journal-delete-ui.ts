export const journalDeleteEndpoint = "/editor/api/journal-delete";

export const journalDeleteFailureGuidance = (code?: string) =>
  ({
    "backup-proof-required":
      "Choose a complete backup generation, then review again.",
    "backup-proof-stale":
      "Create and verify a fresh generation containing the current three files.",
    "incoming-reference":
      "Remove the incoming reference with a separately reviewed Save or keep this Journal.",
    "parser-uncertainty":
